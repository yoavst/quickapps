...
import com.yoavst.quickapps.tools.highScoreInSimon
import com.yoavst.quickapps.tools.qCircleToast
import kotlinx.android.synthetic.simon_activity.round
...
public class CSimonActivity : QCircleActivity() {
    ...
    var ids = intArrayOf(R.id.red, R.id.blue, R.id.green, R.id.yellow)
    var pressedResources = intArrayOf(R.color.md_red_500, R.color.md_blue_500, R.color.md_green_500, R.color.md_yellow_500)
    var regularResources = intArrayOf(R.color.md_red_700, R.color.md_blue_700, R.color.md_green_700, R.color.md_yellow_700)

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentViewToMain(R.layout.simon_activity)
    ...
    fun lose() {
        isGameRunning = false
        if (highScoreInSimon < game!!.getRound()) {
            highScoreInSimon = game!!.getRound()
        }
        val dialog = QCircleDialog.Builder()
                ...
                .setImage(if (beforeLollipop()) getResources().getDrawable(R.drawable.game_over) else getResources().getDrawable(R.drawable.game_over, getTheme()))
                .create()
