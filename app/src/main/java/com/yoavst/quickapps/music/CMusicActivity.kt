...
public class CMusicActivity : QCircleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val qCircleBackButton = QCircleBackButton(this)
        qCircleBackButton.isDark(true)
        qCircleBackButton.setBackgroundTransparent()
        template.addElement(qCircleBackButton)
