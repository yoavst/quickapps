...
public class RecordButton extends ImageView {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		recordingAnimator = ObjectAnimator.ofFloat(this, "animationProgress", 0f, 0f);
		if (!isInEditMode()) {
			off = new IconDrawable(context, Iconify.IconValue.md_keyboard_voice)
					.colorRes(R.color.md_red_500).sizeDp(64);
			on = new IconDrawable(context, Iconify.IconValue.md_stop)
					.colorRes(R.color.md_red_500).sizeDp(64);
	...
	public void setRecording() {
		setImageDrawable(on);
		recordingAnimator.setFloatValues(animationProgress, pressedRingWidth);
	...
	public void setNotRecording() {
		setImageDrawable(off);
		recordingAnimator.setFloatValues(pressedRingWidth, 0f);
		recordingAnimator.setRepeatCount(0);
		recordingAnimator.start();
	}
