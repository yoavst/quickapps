...
public class AudioRecorder {
    ...
    public static final int DEFAULT_AUDIO_ENCODER = MediaRecorder.AudioEncoder.AAC;
    ...
    public static class MediaRecorderConfig {
        ...
        public static final MediaRecorderConfig DEFAULT =
                new MediaRecorderConfig(64 * 1024,              /* 64 Kib per second                                */
                        ...
                        DEFAULT_AUDIO_ENCODER);       /* Default encoder for target Android version       */
    ...
    class StartRecordTask extends AsyncTask<OnStartListener, Void, Exception> {
        ...
        @Override
        protected Exception doInBackground(@NonNull OnStartListener... params) {
    ...
    class PauseRecordTask extends AsyncTask<OnPauseListener, Void, Exception> {
        ...
        @Override
        protected Exception doInBackground(@NonNull OnPauseListener... params) {
