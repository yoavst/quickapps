...
public class WifiFragment : ToggleFragment() {
    val WIFI by stringResource(R.string.wifi)
    val WIFI_OFF by stringResource(R.string.wifi_off)
    val WIFI_ON by stringResource(R.string.wifi_on)
    val WIFI_NETWORK_AVAILABLE by stringResource(R.string.wifi_network_available)
