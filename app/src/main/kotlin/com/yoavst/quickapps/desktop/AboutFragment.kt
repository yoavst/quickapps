...
public class AboutFragment : Fragment() {
    val about: TextView by bindView(R.id.about)
    val blueColor: Int by Delegates.lazy { getColor(R.color.primary_color_dark) }
    val blueLightColor: Int by Delegates.lazy { getColor(R.color.primary_color) }
    val message: CircleButton by bindView(R.id.message)
    val donation: CircleButton by bindView(R.id.donate)
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        donation.setImageDrawable(IconDrawable(getActivity(), Iconify.IconValue.md_payment).sizeDp(32).color(Color.WHITE))
        ...
        message.setOnClickListener {
            ...
            try {
                ...
                showShortToast(R.string.about_intent_failed)
            }
        }
    }
