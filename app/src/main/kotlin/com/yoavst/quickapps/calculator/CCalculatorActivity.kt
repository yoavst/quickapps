...
public class CCalculatorActivity : QCircleActivity() {
    ...
    val text: TextView by bindView(R.id.text_line)
    val answer: TextView  by bindView(R.id.answer_line)
    val pager: ViewPager  by bindView(R.id.pager)
    val DOT: String by Delegates.lazy { getString(R.string.dot) }
    val PLUS: String  by Delegates.lazy { getString(R.string.plus) }
    val MINUS: String  by Delegates.lazy { getString(R.string.minus) }
    val MULTIPLE: String  by Delegates.lazy { getString(R.string.mul) }
    val DIVIDE: String  by Delegates.lazy { getString(R.string.div) }
    val POW: String  by Delegates.lazy { getString(R.string.exponentiation) }
    val ERROR: String  by Delegates.lazy { getString(R.string.error) }
    val SIN: String  by Delegates.lazy { getString(R.string.sin) }
    val ASIN: String  by Delegates.lazy { getString(R.string.asin) }
    val COS: String  by Delegates.lazy { getString(R.string.cos) }
    val ACOS: String  by Delegates.lazy { getString(R.string.acos) }
    val TAN: String  by Delegates.lazy { getString(R.string.tan) }
    val ATAN: String  by Delegates.lazy { getString(R.string.atan) }
    val ANSWER_TEXT: String by Delegates.lazy { getString(R.string.ans) }
    val OPERATORS: Array<String> by Delegates.lazy { getStringArray(R.array.operators) }
