...
public class BluetoothFragment : ToggleFragment() {
    val BLUETOOTH: String by Delegates.lazy { getString(R.string.bluetooth) }
    val BLUETOOTH_OFF: String by Delegates.lazy { getString(R.string.bluetooth_off) }
    val BLUETOOTH_ON: String by Delegates.lazy { getString(R.string.bluetooth_on) }
    val BLUETOOTH_TURN_OFF: String by Delegates.lazy { getString(R.string.bluetooth_turning_off) }
    val BLUETOOTH_TURN_ON: String by Delegates.lazy { getString(R.string.bluetooth_turning_on) }
