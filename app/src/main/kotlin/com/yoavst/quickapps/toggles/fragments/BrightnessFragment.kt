...
public class BrightnessFragment : ToggleFragment() {
    val BRIGHTNESS: String by Delegates.lazy { getString(R.string.brightness) }
    val MED: String by Delegates.lazy { getString(R.string.brightness_med) }
    val AUTO: String by Delegates.lazy { getString(R.string.brightness_auto) }
    val MAX: String by Delegates.lazy { getString(R.string.brightness_max) }
    val LOW: String by Delegates.lazy { getString(R.string.brightness_low) }
