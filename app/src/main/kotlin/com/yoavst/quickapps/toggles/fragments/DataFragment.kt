...
import com.mobsandgeeks.ake.connectivityManager

/**
 * Created by Yoav.
 */
public class DataFragment : ToggleFragment() {
    val DATA: String by Delegates.lazy { getString(R.string.data_data) }
    val DATA_OFF: String by Delegates.lazy { getString(R.string.data_off) }
    val DATA_OFF_AIRPLANE: String by Delegates.lazy { getString(R.string.data_off_airplane) }
    val DATA_ON: String by Delegates.lazy { getString(R.string.data_on) }
