...
public class HotSpotFragment : ToggleFragment() {
    val HOT_SPOT: String by Delegates.lazy { getString(R.string.hotSpot) }
    val OFF: String by Delegates.lazy { getString(R.string.hotSpot_off) }
    val ON: String by Delegates.lazy { getString(R.string.hotSpot_on) }
