...
public class SoundFragment : ToggleFragment() {
    val SOUND: String by Delegates.lazy { getString(R.string.sound_sound) }
    val SILENT: String by Delegates.lazy { getString(R.string.sound_silent) }
    val VIBRATE: String by Delegates.lazy { getString(R.string.sound_vibrate) }
